...
{
    public abstract partial class KPointer
    {
        ////////////////////////////////////////////////////////////////////////
        // Private Methods
        ////////////////////////////////////////////////////////////////////////
        ...
        private RaycastResult Raycast(Ray ray, int layerMask)
        {
            ...
            result.screenPosition = this.EventCamera.WorldToScreenPoint(
            ...
            {
                result = this.Raycast(
                    ray, KProvider.ZeroParallaxPlane.ToPlane(), false);
            }
