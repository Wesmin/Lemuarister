...
{
    public partial class KStylusBeam : KPointerVisualization
    {
        ////////////////////////////////////////////////////////////////////////
        // Inspector Fields
        ////////////////////////////////////////////////////////////////////////
        ...
        public override void Process(KPointer pointer, float worldScale)
        {
            ...
            this._lineRenderer.widthMultiplier =
                this._originalWidthMultiplier * worldScale;
        ...
        private void UpdateLineRendererPositions(KPointer pointer)
        {
            ...
            else
            {
                this._endPoint = Vector3.SmoothDamp(
                    this._endPoint, hitPosition, ref this._velocity,
                    this.EndPointSmoothTime, float.PositiveInfinity,
