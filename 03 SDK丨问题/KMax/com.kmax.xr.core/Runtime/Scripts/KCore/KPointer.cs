...
namespace KmaxXR.Core
{
    ...
    public abstract partial class KPointer : KmaxPointer
    {
        public const int ScriptPriority = KProvider.ScriptPriority + 30;
        ...
        [Serializable]
        public class CollisionEvent : UnityEvent<KPointer, GameObject>
        {
        }

        [Serializable]
        public class IntEvent : UnityEvent<KPointer, int>
        {
        }
        ...
        public KPointerVisualization Visualization = null;
        ...
        /// </summary>
        public virtual Pose EndPointWorldPose
        {
            get
            {
                return new Pose(
        ...
        /// to initiate a drag.
        /// </summary>
        public RaycastResult PressHitInfo
        {
            get
            {
                return this._pressHitInfo;
            }
        }
        ...
        public bool AnyButtonPressed
        {
            get
            {
                return (this._dragButtonId != -1);
            }
        }

        /// <summary>
        /// The ID of the button responsible for initiating the current drag
        /// operation. If no drag operation is active, the button ID will be
        /// -1.
        /// </summary>
        public int DragButtonId
        {
            get
            {
                return this._dragButtonId;
            }
        }

        /// <summary>
        /// The current entered object. If no object has been entered this
        /// frame, the entered object will be null.
        /// </summary>
        ...
        /// <summary>
        /// The current exited object. If no object has been exited this frame,
        /// the exited object will be null.
        /// </summary>
        public GameObject ExitedObject
        {
            get
            {
                return this._exitedObject;
            }
        }
        ...
        /// </summary>
        public Func<KPointer, Plane> DefaultCustomDragPlane { get; set; }
        ...
        /// (e.g. ZInputModule).
        /// </remarks>
        public static IList<KPointer> GetInstances()
        {
            return s_instances;
        }
        ...
        private Matrix4x4 ScreenWorldPoseMatrix
        {
            get
            {
                return KProvider.Viewport.localToWorldMatrix.ToPoseMatrix();
            }
        }
        ...
        private Matrix4x4 DeltaScreenWorldPoseMatrix
        {
            get
            {
                return this.ScreenWorldPoseMatrix *
        ...
        private float DefaultHitDistance
        {
            get
            {
                return this.MaxHitDistance * this.WorldScale;
            }
        }
        ...
        private float DefaultHitRadius
        {
            get
            {
                return this.MaxHitRadius * this.WorldScale;
            }
        }
        ...
        private void Process()
        {
            ...
            {
                this.Visualization.Process(this, KProvider.WorldScale);
            }
        }
        ...
        private void ProcessDragLockHitPosition(ref RaycastResult hitInfo)
        {
            ...
            hitInfo.screenPosition =
                this.EventCamera.WorldToScreenPoint(
                    hitInfo.worldPosition);
        }
        ...
        private static readonly List<KPointer> s_instances =
            new List<KPointer>();
